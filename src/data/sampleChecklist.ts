...
export const sampleChecklist: Checklist = {
  ...
  questions: [
    ...
    {
      id: 'Q_PHOTO_DOC',
      text: 'Photos taken of containers before pickup?',
      description: 'Optional photo documentation for the customer record',
      type: 'Yes/No/NA',
      required: false,
      tags: ['PHOTO_DOC', 'Yes/No/NA', 'Optional', 'Documentation'],
      conditionalQuestions: [
        {
          branch: 'IF YES',
          question: {
            id: 'Q_PHOTO_COUNT',
            text: 'Approximately how many photos were taken?',
            type: 'Number',
            required: false,
            tags: ['PHOTO_COUNT', 'Number', 'Optional', 'Documentation'],
          },
        },
      ],
    },
    {
      id: 'Q_PPE_USED',
      text: 'Which additional PPE was used during the pickup?',
      description: 'Select any items used beyond the standard kit',
      type: 'Multiple Choice',
      required: false,
      tags: ['PPE_USED', 'Multiple Choice', 'Optional', 'Safety'],
      choices: [
        {id: 'face-shield', label: 'Face Shield'},
        {id: 'apron', label: 'Chemical Apron'},
        {id: 'boot-covers', label: 'Boot Covers'},
        {id: 'respirator', label: 'Respirator'},
      ],
    },
    {
      id: 'Q_TIME_ON_SITE',
      text: 'Approximate time on site (minutes)',
      type: 'Number',
      required: false,
      tags: ['TIME_ON_SITE', 'Number', 'Optional', 'Collection Details'],
    },
    {
      id: 'Q5_ADD_NOTES',
      ...
      type: 'Text',
      required: false,
      tags: ['ADD_NOTES', 'Text', 'Optional', 'Collection Details'],
    },
  ],
  created: '11/14/2024',
