...
export interface OrderContainersReviewScreenProps {
  ...
  /** Optional technician display name for auto-generated LDR. */
        ...
        <Button
          ...
          onPress={() => {
            void (async () => {
              ...
              if (!hasManifestForOrder(selectedOrderData.orderNumber)) {
                trackingNumber = generateManifestTrackingNumber();
              ...
              if (trackingNumber) {
                const wasteCodes = Array.from(
                  new Set(
                    activeContainers.flatMap(
                      container => container.wasteCodes ?? [],
                    ),
                  ),
                );
                try {
                  await ensureLdrDocumentPhoto({
                  ...
                  console.warn(
                    'Failed to auto-generate LDR document photo',
                    error,
                  );
                }
              }
