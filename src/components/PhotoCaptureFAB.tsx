...
export const PhotoCaptureFAB: React.FC<PhotoCaptureFABProps> = ({
  orderNumber,
  onPhotoAdded,
  onViewPhotos,
  onScanDocument,
    ...
    <>
      <TouchableOpacity
        ...
        <View style={styles.fabContent}>
          <Icon name="camera-alt" size={28} color={colors.primaryForeground} />
          {photoCount > 0 && (
            <View style={styles.fabBadge}>
              <Text style={styles.fabBadgeText}>{photoCount}</Text>
            </View>
          )}
        </View>
      </TouchableOpacity>
